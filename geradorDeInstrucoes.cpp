...
em sequencia.
*/
#define TAM_MEM 10001 //Tamanho da RAM
#define NUM_INS 110  //Quantidade de instrucoes -> Maior que o TAM_FOR (vide item 2 das observacoes).
...
. "tratador_interrupcao.txt"    "instrucoes.txt" .
...
int main() {
	...
	ofstream instrucoes;
	instrucoes.open("tratador_interrupcao.txt");
