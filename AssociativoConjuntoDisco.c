/*
 ============================================================================
 Name        : TP3.c
 Author      : Lavinia Fonseca
 Version     :
 Copyright   : Your copyright notice
 Description : Terceiro TP de organizacaoo de computadores - Criacao da Maquina - Foco no disco externo
 ============================================================================
 */
...
void maquina();
void montarInterrupcoes(int chance);
...
char* nomearDiretorioArquivos(int indice){
    char endArqTXT[10];
    char *diretorio = "C:\\Users\\kiubixo\\Desktop\\UFOP\\ORGANIZACAO\\ArquivosTXT\\";
    char *tipoArq = ".txt";
...
void montarInstrucoesProgramaAleatorio(){
    ...
    memoriaInstrucoesNormal = malloc(tamanhoProgramaNormal * sizeof(Instrucao));
    ...
    for (int i = 0; i < tamanhoProgramaNormal - 1; i++){
    ...
    memoriaInstrucoesNormal[tamanhoProgramaNormal - 1] = *umaInstrucao;
    free(umaInstrucao);
}
